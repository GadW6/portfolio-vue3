      ...
      <g id="Scroll_Down_lines" transform="translate(-916.732 -945.453)">
        <g id="Scroll_down_1">
          <line
            ...
            data-name="Line 1"
            x2="70"
            transform="matrix(0.574, 0.819, -0.819, 0.574, 918.821, 991.542)"
            fill="none"
            stroke="#a2a2a2"
          ...
          <line
            ...
            data-name="Line 2"
            x2="70"
            transform="translate(958.821 1048.883) rotate(-55)"
            fill="none"
            stroke="#a2a2a2"
            stroke-linecap="round"
            stroke-width="3"
